...
st.markdown(
    """
    - 첨부된 통합 엑셀(**상속세_결정현황_통합(2019-2025).xlsx**)의 **모든 시트**를 스캔하여
...
# ---------- 파일 입력(업로더 제거, 고정 경로 사용) ----------
fixed_path = Path("./상속세_결정현황_통합(2019-2025).xlsx")  # 같은 폴더 실행 시 자동 인식
alt_path = Path("/mnt/data/상속세_결정현황_통합(2019-2025).xlsx")  # 노트북/샌드박스 경로 대비
...
if fixed_path.exists():
    ...
    st.error("첨부된 통합 엑셀을 찾을 수 없습니다: 상속세_결정현황_통합(2019-2025).xlsx")
    st.stop()
